...
//                .collect(Collectors.groupingBy(i -> i, Collectors.counting()));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(RangeMaximumQuery.genomicRangeQuery(new int[]{1, 2, 3, 5, 2, 4, 7, 12, 10, 5, 7}, new int[]{2, 5, 0, 3, 8}, new int[]{4, 5, 6, 7, 10})));
        System.out.println(Arrays.toString(RangeMinimumQuery.genomicRangeQuery("CAGCCTA", new int[]{2, 5, 0}, new int[]{4, 5, 6})));
        //System.out.println(Arrays.toString(RangeMaximumQuery.genomicRangeQuery("CAGCCTA", new int[]{2, 5, 0}, new int[]{4, 5, 6})));
