...
public class Forismatic {
    ...
    private Quote parseXML(String xmlString) {
        ...
        InputSource source1 = new InputSource(new StringReader(xmlString)), source2 = new InputSource(
    ...
    private String getXML() {
        ...
        try {
            ...
            connection.addRequestProperty("User-Agent",
                                          "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0)");//без него не работает, error 403
